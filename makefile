CC = g++
PROM = raytracer.o
OBJ = raytracing.o raytracer/ray.o raytracer/tracer.o geometry/mesh.o geometry/objects.o geometry/marchingcube.o LS/evolve.o mpi/mpi.o
...
mpi.o: mpi/mpi.cpp mpi/mpi.hpp constants.hpp
	$(CC) $(CFLAGS) -c mpi/mpi.cpp
